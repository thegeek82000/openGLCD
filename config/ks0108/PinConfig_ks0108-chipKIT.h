/*
 * ks0108_chipKIT.h - User specific configuration for openGLCD library
 *
 * Use this file to set io pins
 * This pinconfig file used when using chipKIT boards
 *
*/
 ...
 */
#define glcd_PinConfigName "ks0108-chipKIT"
