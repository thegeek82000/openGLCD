 ...
 * GLCDexample
 *
 * Basic test code for the Arduino openGLCD library.
...
void showCharacters(const char * title, Font_t font)
{
  ...
  textArea.DefineArea(GLCD.CenterX + 5, 3, GLCD.Right-2, GLCD.Bottom-4);
  textArea.SelectFont(font); 
